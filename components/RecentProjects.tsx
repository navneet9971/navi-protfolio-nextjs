...
{projects.map(({ id, title, des, img, iconLists, live, github, perview, gitText }) => (
    <CardContainer className="inter-var">
      ...
      <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black-300 dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border">
